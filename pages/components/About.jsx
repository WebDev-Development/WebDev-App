...
export default function About() {
  ...
  return (
    <div id="section-about" className="flex flex-col text-left bg-black text-white">
      <h3 className="py-2 pl-3 pr-4 text-color text-center text-3xl">{t.values}</h3>
      <div className="text-center flex justify-center pt-3 pb-4 xs:flex-col sm:flex-col md:flex-row">
        <div className="flex flex-col items-center bg-color bg-opacity-5 p-3 border border-color rounded-lg m-3 xs:w-full sm:w-full md:w-auto">
      ...
      <div className="p-6">
        <h3 className="py-2 pl-2 pr-4 text-color text-3xl">{t.story}</h3>
