...
export default function Nav() {
  ...
  return (
    <nav class="bg-white w-full z-20 top-0 left-0 border-b border-gray-200 fixed">
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium md:flex-row md:space-x-8 md:mt-0 md:border-0">
          <li>
            <a href="#section-about" class="block py-2 pl-3 pr-4 text-black rounded md:p-0 hover:bg-black hover:bg-opacity-10">{t.about}</a>
          </li>
          <li>
            <a href="#section-services" class="block py-2 pl-3 pr-4 text-black rounded md:p-0 hover:bg-black hover:bg-opacity-10" >{t.services}</a>
          </li>
          <li>
            <a href="#section-contact" class="block py-2 pl-3 pr-4 text-black rounded md:p-0 hover:bg-black hover:bg-opacity-10">{t.contact}</a>
          </li>
        </ul>
      </div>
      </div>
